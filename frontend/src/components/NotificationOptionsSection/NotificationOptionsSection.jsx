...
export const NotificationOptionsSection = ({ adData, onClose, onSave }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const updatedAd = {
      ...
      image: formData.imagePreview || adData?.image,
              ...
              <div className="form-section form-section-image">
                ...
                {formData.imagePreview ? (
                  ...
                  <label className="image-upload-container">
                    ...
                    />
                    <span className="image-upload-text">برای آپلود تصویر کلیک کنید</span>
                    <span className="image-upload-subtext">فرمت‌های مجاز: JPG, PNG, SVG</span>
                  </label>
                )}
              </div>
