...
export default function ChatPage() {
  ...
  useEffect(() => {
    ...
    const pendingName = state.recipientName || "Unknown";
    const pendingAvatar =
      resolveAvatarUrl(state.recipientAvatar) || DEFAULT_AVATAR;
    ...
    if (state.openChatId) {
      ...
      setPendingRecipientInfo({
        ...
        title: name || pendingName,
        avatar: pendingAvatar,
      });
      pendingRecipientIdRef.current = state.recipientId;
      setRecipient({ id: state.recipientId, username: name || pendingName });
      if (isCompactLayout) setShowDetailPane(true);
    }
  ...
  const openChat = useMemo(() => {
    if (selectedChatId) {
      ...
      if (pendingRecipientInfo) {
        return {
          id: selectedChatId,
          title: pendingRecipientInfo.title,
          subtitle: "",
          avatar: pendingRecipientInfo.avatar,
        };
      }
      return null;
    }
