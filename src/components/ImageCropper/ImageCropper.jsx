                ...
                <div className="control-group">
                  <div className="control-header">
                    ...
                    <div className="control-value-group">
                      <span className="control-value">{scale.toFixed(2)}x</span>
                      <div className="control-buttons">
                        <button
                          className="control-btn control-btn-minus"
                          onClick={() => handleScaleIncrement(-0.1)}
                          disabled={scale <= minZoom || isLoading}
                        >
                          −
                        </button>
                        <button
                  ...
                  <input
                    ...
                    style={{ "--value": (scale - minZoom) / (maxZoom - minZoom) }}
                    disabled={isLoading}
                  />
                ...
                <div className="info-content">
                  ...
                  <div className="info-specs">
                    ...
                    <div className="spec-item">
                      ...
                      <span className="spec-value">{minZoom}x تا {maxZoom}x</span>
                    </div>
                  </div>
                </div>
              </div>
