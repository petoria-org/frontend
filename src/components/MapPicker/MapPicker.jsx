...
export default function MapPicker({
  ...
  useEffect(() => {
    if (value?.lat && value?.lng) {
      setPointInternal([value.lat, value.lng]);
    }
  }, [value]);
    ...
    const fetchReverseGeocode = async () => {
      ...
      try {
        ...
        const newAddress = {
          ...
          state: addr.state || "",
          road: addr.road || "",
          readable: res.data.display_name || "",
        };
        ...
        const fallbackAddress = {
          ...
          city: "",
          district: "",
          readable: `موقعیت: ${point[0].toFixed(4)}, ${point[1].toFixed(4)}`,
        };
        ...
        if (onChange) {
          onChange({
            lat: point[0],
            lng: point[1],
            readable: fallbackAddress.readable,
          });
        }
      } finally {
                ...
                <div className="address-list">
                  {address.road && (
                    <div className="address-item">
                      ...
                      <div>
                        <div className="address-label">خیابان</div>
                        <div className="address-value">{address.road}</div>
                      </div>
                    </div>
                  )}
                  {address.district && (
                    <div className="address-item">
                      ...
                      <div>
                        <div className="address-label">محله</div>
                        <div className="address-value">{address.district}</div>
                      </div>
                    </div>
                  )}
                  {address.city && (
                    <div className="address-item">
                      ...
                      <div>
                        <div className="address-label">شهر</div>
                  ...
                  {address.state && (
                    <div className="address-item">
                      ...
                      <div>
                        <div className="address-label">استان</div>
                  ...
                  {address.country && (
                    <div className="address-item">
                      ...
                      <div>
                        <div className="address-label">کشور</div>
                        <div className="address-value">{address.country}</div>
                      </div>
                    </div>
                  )}
            ...
            <div className="actions-section">
              ...
              <div className="action-buttons">
                ...
                <button 
                  ...
                  onClick={() => {
                    navigator.clipboard.writeText(`${point[0]}, ${point[1]}`);
                    alert("مختصات کپی شد!");
                  }}
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
